...
function analyzeUrl(parentUrl, url) {
  var origin = parentUrl.substr(
    0,
    parentUrl.slice(parentUrl.indexOf("//") + 2).indexOf("/") +
      parentUrl.indexOf("//") +
      2
  );
  ...
  var hostname =
    host.indexOf(":") !== -1 ? host.substr(0, host.indexOf(":")) : host;
  var port = host.indexOf(":") !== -1 ? host.slice(host.indexOf(":") + 1) : "";
  var pathname = parentUrl.slice(
    parentUrl.slice(parentUrl.indexOf("//") + 2).indexOf("/") +
      parentUrl.indexOf("//") +
      2
  );
  ...
  var search =
    parentUrl.indexOf("?") !== -1
      ? parentUrl.slice(parentUrl.indexOf("?"))
      : "";
  search =
    search.indexOf("#") !== -1 ? search.substr(0, search.indexOf("#")) : search;
  var hash =
    parentUrl.indexOf("#") !== -1
      ? parentUrl.slice(parentUrl.indexOf("#"))
      : "";
